...
#define SekaiMap_Texture "tex_chr_MIK_00_H.png" //The texture that ends with "_H"
#define ShadowColorMap_Texture "tex_chr_MIK_00_S.png" //The texture that ends with "_S"
